...
AddEventHandler('ps-drugprocessing:processHydrochloric_acid', function()
	...
	TriggerClientEvent('QBCore:Notify', src, 'Das Salzsäureverfahren war erfolgreich!', "success")
end)
...
AddEventHandler('ps-drugprocessing:processsodium_hydroxide', function()
	...
	TriggerClientEvent('QBCore:Notify', src, 'Das Natriumhydroxid-Verfahren war erfolgreich!', "success")
end)
...
AddEventHandler('ps-drugprocessing:processprocess_sulfuric_acid', function()
	...
	TriggerClientEvent('QBCore:Notify', src, 'Das Schwefelsäureverfahren war erfolgreich!', "success")
end)
...
AddEventHandler('ps-drugprocessing:process_lsa', function()
	...
	TriggerClientEvent('QBCore:Notify', src, 'Das LSA-Verfahren war erfolgreich!', "success")
end)