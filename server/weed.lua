...
AddEventHandler('ps-drugprocessing:processCannabis', function()
	...
	TriggerClientEvent('QBCore:Notify', src, 'Cannabis erfolgreich verarbeitet!', "success")
end)
...
AddEventHandler('ps-drugprocessing:rollJoint', function()
	...
	TriggerClientEvent('QBCore:Notify', src, 'Du hast erfolgreich einen Joint gedreht!', "success")
end)
