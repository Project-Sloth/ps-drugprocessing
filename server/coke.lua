...
AddEventHandler('ps-drugprocessing:processCocaLeaf', function()
	...
	TriggerClientEvent('QBCore:Notify', src, 'Kokainblätter erfolgreich verarbeitet!', "success")
end)
...
AddEventHandler('ps-drugprocessing:processCocaPowder', function()
	...
	TriggerClientEvent('QBCore:Notify', src, 'Kokain-Pulver erfolgreich geschnitten!', "success")
end)
...
AddEventHandler('ps-drugprocessing:processCocaBrick', function()
	...
	TriggerClientEvent('QBCore:Notify', src, 'Kokainpackung für den Vertrieb gepresst!', "success")
end)
