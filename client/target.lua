        ...
        options = {
            {
                ...
                icon = "fas fa-vials",
                label = "Etwas Wunderbares und Blaues kochen",
        ...
        options = {
            {
                ...
                icon = "fas fa-envira",
                label = "Verarbeiten und Trocknen",
            },
        },
    distance = 3.5
    })
