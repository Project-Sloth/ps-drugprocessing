local Translations = {
    error = {
        ...
        not_all_items = "Tu n'a pas les items dont du as besoin !",
        ...
        no_liquidmix = "Il te manque mélange chimique liquide !",
    ...
    success = {
        ...
        thionyl_chloride = "Chlorure de thionyle traité avec succès !",
